...
public class ReviewReplyWriteService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			int result = dao.replyReview(mid, rtitle, rcontent, rip, dto.getRgroup(), dto.getRstep(), dto.getRindent(), rfilename[2], rfilename[1], rfilename[0]);
