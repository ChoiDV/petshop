...
--  답변글 쓰기
INSERT INTO FREEBOARD(FNUM, MID, FTITLE, FCONTENT, FGROUP, FSTEP, FINDENT, FIP, FFILENAME1, FFILENAME2, FFILENAME3 )
    VALUES ( FREE_SEQ.NEXTVAL, 'ccc', '답변글-악플1', '야이자식아', 2, 1, 1, '127.0.0.1', NULL, NULL, NULL );
    
UPDATE FREEBOARD SET FSTEP = FSTEP +1
    WHERE FGROUP=2 AND FSTEP > 0;
    
INSERT INTO FREEBOARD(FNUM, MID, FTITLE, FCONTENT, FGROUP, FSTEP, FINDENT, FIP, FFILENAME1, FFILENAME2, FFILENAME3 )
    VALUES ( FREE_SEQ.NEXTVAL, 'ccc', '답변글-악플2', '야이자식아', 2, 1, 1, '127.0.0.1', NULL, NULL, NULL );
    
UPDATE FREEBOARD SET FSTEP = FSTEP +1
    WHERE FGROUP=2 AND FSTEP > 0;
    
INSERT INTO FREEBOARD(FNUM, MID, FTITLE, FCONTENT, FGROUP, FSTEP, FINDENT, FIP, FFILENAME1, FFILENAME2, FFILENAME3 )
    VALUES ( FREE_SEQ.NEXTVAL, 'ccc', '답변글-악플3', '야이자식아', 2, 1, 1, '127.0.0.1', NULL, NULL, NULL );
